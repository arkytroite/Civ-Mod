...
* Commerce
  * The Commerce Tree has been reordered
    ...
    * Mercenary Army now requires Mercantilism
...
* Imperialism
  ...
  * Maritime Infrastructure now allows Lighthouses, Harbors, and Seaports to be built 50% faster.
...
* Freedom
  * Renamed Liberalism
  * Covert Action now gives an additional spy.
  * Economic Union's Gold to other Freedom Civs has been increased to +10 and it now also gives +4 Gold for Oil.
  * Volunteer Army moved to Level 1 and now provides +1 Sight, 15% Combat Strength, and +15 Healing to all units. It no longer gives Free Units.
  * Their Finest Hour has been replaced with Free Speech, which gives +50% Musician Generation and +25% Tourism generated by Great Works.
  ...
  * Civil Society is now a level 3 tenent.
* Order
  * Renamed Communism
  * Cultural Revolution replaced with World Revolution, a level 1 Policy that gives +25% Tourism to other Communist civs and +8 Gold from Trade Routes to them.
  * Skyscrapers has been renamed to Brutalist Architecture.
  * Young Pioneers has been replaced by Great Leap Forward, a level 2 tenent that gives 8 free coal, +100% Factory production, and +4 Culture per Factory.
  * Patriotic War replaced with Rural Resettlement, giving +1 Culture from Farms, Plantations, and Pastures and extra Strength in home territory.
  * Double Agents replaced with State Monopoly, giving +50% Strategic Resources, +2 Production on those resources, and double efficiency stopping spies.
...
* Autocracy
  * Renamed Fascism
  * United Front replaced with Mandatory Service, which gives 25% reduced unit maintenance.
  * Futurism replaced with Master Race, which gives slaves upon city capture and prevents slave rebellions.
  * Mobilization has been replaced with Military Industrial Complex, which reduces the Gold cost of upgrading units by 25%.
  * Industrial Espionage now only gives 50% faster technology theft, but you get +2 Science per Customs House and +25% Science from the National Intelligence Agency. It has been moved to a level 2 tenet.
  ...
  * Police State has been replaced by Martial Law, which gives +2 Happiness in garrisoned cities.
  * Nationalism has been replaced by Ubermensch, which gives +25% Great People Generation.
  * Militarism has been replaced by New Synthesis, which is a level 3 tenet that gives +1 Science and Culture per Specialist.
  * Lightning Warfare has been replaced with Blitzkrieg, which gives the following benefits.
    * non-ranged units flank attack bonus is increased by 50%
    * Gunpowder-class units ignore enemy Zones of Control
  ...
  * Clausewitz's Legacy replaced with Blood and Soil, which gives the following benefits:
    ...
    * Courthouses are built 4 times as fast and give +3 Happiness, +15% Science, and +15% Food.
...
* The new Policy Trees get new Wonders. 
  ...
  * Authority gets the National Industrial Complex, which provides +3 Production on all Strategic Resources. This is not a World Wonder; each player may have up to 2.
...
* Slaves captured (or rescued) by barbarians become barbarians themselves after one Turn.
...
* New Recon Units
  ...
  * At Rifling, it becomes a Surveyor, which is even faster and stronger.
...
## Visual Changes
* Conquered cities no longer have their architecture changed to match their conquerer.
* Landmarks now look different depending on the architecture type of their builder.
* Most promotions now use unique icons instead of the generic yellow triangle.
* Adds a new icon for the Ship of the Line
## Adjusted Natural Wonder Spawning
* Prevents Wonders from spawning on single tile islands
* Prevents The Great Barrier Reef from spawning under Ice
* Prevents The Great Barrier Reef and Krakatoa from spawning in unworkable tiles
* Prevents most Natural Wonders from spawning in snow
...
* Portugal's Feitoria no longer remove jungles or forests in their tile.
* Lake Victoria is now considered a Lake by the Aztec Floating Gardens.
...
* If you get a Free Tech from a ruin, and it happens to be the tech you were Researching, you get a small boost towards your next technology.
* Reduces the time required to build a Fort
* Reduces the hammers required to build a work boat.
